...
//               <img
//                 src={photo.thumbnail_420_url} // Use the specific thumbnail URL
//                 alt={photo.originalFilename || 'Session photo'}
//                 className="w-full h-full object-cover"
//                 loading="lazy" // Critical for grid performance
//                 width={photo.width ? Math.min(photo.width, 420) : 420} // Use photo.width if available, but cap at 420 for thumbnail
//                 height={photo.height ? Math.min(photo.height, 420) : 420} // Same for height
//               />
//             </div>
//           )}
//         </div>
